<html>
    ...
    <body>
        <div class="container-fluid"><div class="col-md-offset-5 col-md-2" style="margin-top:40px">
        ...
        <?php
            ...
            {
                $query = "INSERT INTO `products`(`name`, `price`, `category`) VALUES ('".$_POST['name']."','".$_POST['price']."','".$_POST['category']."')";
